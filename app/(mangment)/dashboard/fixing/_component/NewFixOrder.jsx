...
import  CarsList  from "../neworder/_component/CarsList";
import { CardBody } from "../neworder/_component/CardBody";
import { CardFinice } from "../neworder/_component/CardFinice";
import { CardImage } from "../neworder/_component/CardImage";
import { CardAction } from "../neworder/_component/CardAction";
import { CardNote } from "../neworder/_component/CardNote";
...
function NewFixOrder({  carData, labor }) {
  ...
  return (
    <div className="flex flex-col w-full items-start justify-start max-w-5xl mt-5  h-[80vh] bg-gray-500 p-2 rounded">
      {/* <PageTitle
        ...
        bgColor="bg-sky-600"
      /> */}
      <div className="flex items-start justify-center  text-white w-full h-full   gap-2 ">
        <CarsList
          setCarid={setCarid}
      ...
      {/* {isShow && (
        <ShowCars isShow={isShow} setIsShow={setIsShow} carData={carData} />
      )} */}
    </div>
  );
}
