  ...
  return (
    <div className="flex items-center justify-evenly  w-full">
      <Button
        ...
        size="sm"
        className="flex items-center justify-center border  h-9 h-9 text-red-500 bg-transpernt "
      >
      ...
      <Button
        ...
        size="sm"
        className="flex items-center justify-center h-9 h-9 border  bg-transpernt"
      >
      ...
      <AlertDialog dir="RTL" open={open} onOpenChange={setOpen}>
        <AlertDialogContent className="bg-gray-300">
          <AlertDialogHeader>
            ...
            >
              {" "}
              {type === "update" ? "تعديل ملف عميل" : "حذف ملف عميل"}
            </AlertDialogTitle>
          </AlertDialogHeader>
          <FormAction
            type={type}
      ...
      >
        ...
        <div className="flex flex-col w-full gap-4 ">
          <INPUT
            ...
            onChange={(event) =>
              setClientData({ ...ClientData, mobile: event.target.value })
            }
