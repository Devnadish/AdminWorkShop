...
function Caption({
  ...
  return (
    ...
    >
      ...
      <span
        className={`${dataTextColor} ${h} ${dataBgColor} ${align} flex-1 pl-3 font-bold  flex items-center justify-${align}  py-1  px-2 `}
      >
        {data}
      </span>
    </div>
    ...
    <div className="flex items-center justify-end  text-base ">
      <div
        className={`flex items-center justify-end  border-b  ${
          type === "lastupdate" ? "border-green-300" : "border-white/40"
...
export function VCaption({
  ...
  return (
    <div
      className={`flex items-center justify-center ${
        isBorder && " border  border-white/30"
      }  w-full rounded flex-col ${fonSize}`}
    >
      <span
